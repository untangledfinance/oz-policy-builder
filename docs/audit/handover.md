...
| [`offchain-gate.log`](evidence/offchain-gate.log) | `biome check .`, `bun run typecheck`, `bun test` | clean; 597 pass, 1 skip, 0 fail |
...
| Off-chain | `bun test` | 597 passed, 1 skipped, 0 failed |
