...
| [`offchain-gate.log`](evidence/offchain-gate.log) | `biome check .`, `bun run typecheck`, `bun test` | clean; 602 pass, 1 skip, 0 fail |
...
| Off-chain | `bun test` | 602 passed, 1 skipped, 0 failed |
