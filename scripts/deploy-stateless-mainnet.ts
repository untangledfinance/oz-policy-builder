...
const artifactDir = resolve(value('--artifact-dir', '/home/ubuntu/work/prime-stateless-wasm/wasm32v1-none/release')!)
...
if (!(await instancePresent())) await submit('deploy stateless-bound interpreter v5', await simulate(create()), instanceBudget)
...
if (!rpc.Api.isSimulationSuccess(versionSim) || !versionSim.result || scValToNative(versionSim.result.retval) !== 5) {
